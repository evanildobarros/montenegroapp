 ...
 * @var array $zonas
 * @var array $zonas_selecionadas_cadastro
 */
...
<section class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                <?php echo __('Adicionar tabela de preço') ?>
            </h3>
        </div>
                ...
                <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                    <div class="row">
                        ...
                        echo $this->Form->control('zonas._ids', [
                            ...
                            'multiple' => 'multiple',
                            'style' => 'height: 250px;',
                            'options' => $zonas_selecionadas_cadastro,
                            'templateVars' => [
                                'classContainer' => 'col-sm-12 col-md-12 col-lg-12 col-xl-12',
                            ],
                        ]);
...
<script>
    $(document).ready(function() {
        ...
        campoCidadeId.change(function() {
            ...
            const request = axios.get('<?= Router::url(['controller' => 'Zonas', 'action' => 'bairrosPorCidade']) ?>', {
                params: {
                    cidade_id: cidade_id,
                },
                headers: {
