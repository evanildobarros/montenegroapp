...
<section class="content">
    ...
    <div class="alert alert-warning alert-dismissible fade show" role="alert">
        ...
        <p class="m-0">
            Se o meio de entrega/coleta não possui limites máximos, deixe os campos Altura, Largura e Profundidade vazios.
        </p>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                <?php echo __('Adicionar Meios de entrega/coleta') ?>
            </h3>
        </div>
