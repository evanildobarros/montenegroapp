...
<section class="content">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <?php echo $this->Html->link(__('Clientes'), ['action' => 'index'], ['escape' => false, 'title' => __('Clientes')]); ?>
        </li>
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="block">
                        ...
                        <div class="block-body">
                            <div class="row">
                                <?php
                                echo $this->Form->control('valor_fixo_pedidos', [
                                    'type' => 'monetary',
                                    'label' => [
                                        'text' => 'Valor fixo dos pedidos',
                                        'tooltip' => 'Atenção! Qualquer pedido terá este valor fixo independente do endereço.',
                                    ],
                                ]);
                                ?>
                            </div>
    ...
    $(document).ready(function () {
        ...
        function toggleTipo() {
            switch ($('input[name="tipo"]:checked').val()) {
                case fisica:
                    campoCpf.attr('required', true).closest('.form-group').addClass('required').show();
                    campoCnpj.attr('required', false).val('').closest('.form-group').removeClass('required').hide();
                    ...
                    break;
                case juridica:
                    campoCpf.attr('required', false).val('').closest('.form-group').removeClass('required').hide();
                    campoCnpj.attr('required', true).closest('.form-group').addClass('required').show();
