...
<section class="pedidos index content">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">
            <?= __('Aguardando finalizar rota') ?>
        </li>
    </ol>
    <div class="alert alert-info alert-dismissible fade show" role="alert">
        Pedidos que coletados ou entregues que estão aguardando a rota ser Finalizada.
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center">
            <h3 class="card-title">
                <?= __('Pedidos aguardando finalizar rota'); ?>
            </h3>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover" id="dataTable">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="text-center"><?= $this->Paginator->sort('entregue', 'Entregue/Coletado') ?></th>
                                <th scope="col"
                                ...
                                <tr data-identifier="<?= $pedido->id ?>">
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex align-items-center justify-content-center">
                                            <?= $this->Html->link("<i class='fas fa-pencil-alt'></i>", ['action' => 'edit', $pedido->id, '?' => ['redirect' => 'aguardandoFinalizarRotas']], ['escape' => false, 'class' => 'btn btn-sm btn-warning action-link', 'title' => 'Editar']) ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="entregarModalLabel">Entregar objeto</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success" id="saveModal" form="formEntregar">Salvar</button>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    echo $this->Form->control('tipo', [
                        'type' => 'hidden',
                        'value' => RotaPedidosTable::ENTREGA,
                    ]);
