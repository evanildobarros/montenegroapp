...
<section class="pedidos index content">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">
            <?= __('Aguardando entregas') ?>
        </li>
    </ol>
    <div class="alert alert-info alert-dismissible fade show" role="alert">
        Pedidos que estão aguardando entrega, o objeto já foi recebido ou coletado.
                                ...
                                <tr data-identifier="<?= $pedido->id ?>">
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex align-items-center justify-content-center">
                                            ...
                                            <?= $this->Html->link("<i class='fas fa-pencil-alt'></i>", ['action' => 'edit', $pedido->id, '?' => ['redirect' => 'aguardandoEntregas']], ['escape' => false, 'class' => 'btn btn-sm btn-warning action-link', 'title' => 'Editar']) ?>
