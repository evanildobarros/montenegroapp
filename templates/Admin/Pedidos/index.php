                        ...
                        <table class="table table-striped table-hover" id="dataTable">
                            ...
                            <?php foreach ($pedidos as $pedido): ?>
                                <tr data-identifier="<?= $pedido->id ?>">
                                    ...
                                    <td>
                                        <?php
                                        if ($pedido->has('pessoa')) {
                                            echo $this->Html->link(
                                                $this->Text->truncate(h($pedido->pessoa->nome), 60, ['exact' => false]),
                                                ['controller' => 'Clientes', 'action' => 'edit', $pedido->pessoa->id]
                                            );
                                        }
                                        ?>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex align-items-center justify-content-center">
                                            <?= $this->Html->link("<i class='fas fa-tag'></i>", ['controller' => 'pdf', 'action' => 'etiqueta', $pedido->id, '_ext' => 'pdf', 'prefix' => false], ['escape' => false, 'class' => 'btn btn-sm btn-maroon action-link', 'title' => 'Atualizações']) ?>
                                            <?= $this->Html->link("<i class='fas fa-sync-alt'></i>", ['controller' => 'atualizacoes', 'action' => 'index', $pedido->id], ['escape' => false, 'class' => 'btn btn-sm btn-purple action-link', 'title' => 'Atualizações']) ?>
